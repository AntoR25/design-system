...
<template>
    <Container>
      <TitresH1> Equipe </TitresH1>
      <br>
        <div class="flex flex-wrap justify-center gap-4">
  <!-- Card 1 -->
  <div class="sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4">
    <div class="relative bg-green-40 flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
      <!-- Card Content -->
      <div class="flex items-center p-7 w-full h-36 bg-white rounded-md shadow-lg">
        <section class="flex justify-center items-center w-14 h-12 rounded-full shadow-md bg-gradient-to-r from-[#F9C97C] to-[#A2E9C1] hover:from-[#C9A9E9] hover:to-[#7EE7FC] hover:cursor-pointer hover:scale-110 duration-300">
